 ...
 * - _copyDiscardStmt
 * - _copyCreateProfileStmt
 * - _copyDropProfileStmt
 * - _copyCreateTableGroupStmt
 ...
 * - _copyBackfillIndexStmt
 * - _copyYbBackfillInfo
 * - _copyRowBounds
 * - _copyYbExprColrefDesc
 * - _copyYbBatchedExpr
 * - _copyYbSkippableEntities
 * - _copyYbUpdateAffectedEntities
 *--------------------------------------------------------------------
 */
