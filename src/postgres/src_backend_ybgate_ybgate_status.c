 ...
 * - YbgStatusGetContext
 * - YbgStatusSetEdata
 * - YbgStatusGetFilename
 * - YbgStatusGetLineNumber
 * - YbgStatusIsError
 * - YbgStatusSetLevel
 * - YbgStatusSetMessageAndArgs
 * - YbgStatusSetSqlError
 * - YbgStatusSetFilename
 * - YbgStatusSetLineNumber
 * - YbgStatusSetFuncname
 * - YbgStatusGetMessage
 * - YbgStatusGetMessageArgs
 * - YbgStatusGetSqlError
 * - YbgStatusGetFuncname
 * - YbgStatusDestroy
 *--------------------------------------------------------------------
 */
